...
export const TOOL_CONFIGS: ToolConfig[] = [
  ...
  { id: 'endsequences', nameKey: 'endSequences', icon: 'Braces', shortcut: 'X', order: 9 },
  { id: 'gibberish', nameKey: 'gibberish', icon: 'MessageCircle', shortcut: 'G', order: 10 },
  { id: 'promptcraft', nameKey: 'promptcraft', icon: 'WandSparkles', shortcut: 'P', order: 11 },
  { id: 'translate', nameKey: 'translate', icon: 'Languages', shortcut: 'L', order: 12 },
  { id: 'anticlassifier', nameKey: 'anticlassifier', icon: 'Bot', shortcut: 'A', order: 13 },
  { id: 'ccbos', nameKey: 'ccbos', icon: 'Scroll', shortcut: 'C', order: 14 },
  { id: 'guardrails', nameKey: 'guardrails', icon: 'ShieldCheck', shortcut: 'R', order: 15 },
  { id: 'mutator', nameKey: 'mutator', icon: 'GitBranch', shortcut: 'M', order: 16 },
  { id: 'multiturn', nameKey: 'multiturn', icon: 'MessagesSquare', shortcut: 'U', order: 17 },
  { id: 'injection', nameKey: 'injection', icon: 'Search', shortcut: 'I', order: 18 },
